  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
      <div className="lg:col-span-2 space-y-6">
        <StoryTray />
        {isCreator && (<div className="pt-2"><CreatePostInput /></div>)}
        {feedPosts.length > 0 ? (
          ...
          <div className="text-center py-20 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-transparent">
            ...
            <button onClick={onGoToDiscover} className="mt-6 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 px-6 rounded-full transition-colors duration-300 flex items-center gap-2 mx-auto">
